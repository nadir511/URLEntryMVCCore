...
namespace URLEntryMVC.Models;

public partial class TapthatOnlineDbUrldbContext : DbContext
{
    public TapthatOnlineDbUrldbContext()
    {
    }

    public TapthatOnlineDbUrldbContext(DbContextOptions<TapthatOnlineDbUrldbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=mssql12.unoeuro.com;Initial Catalog=tapthat_online_db_urldb;User ID=tapthat_online;Password=94xRkFhHw3b6fDae5ApG;TrustServerCertificate=True");
